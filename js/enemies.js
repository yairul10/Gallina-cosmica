import { 
    canvas, score, setScore, coins, setCoins, lives, setLives, gameTime, 
    gameState, setGameState, previousState, setPreviousState, evolutionStage, 
    maxUpgradeLimit, nextBossScoreThreshold, setNextBossScoreThreshold, upgrades, 
    enemies, bossBullets, bosses, gameRound, setGameRound, goingToRound, setGoingToRound, 
    timeAt40k, shieldUnlocked, shieldActive, setShieldActive, partialHit, setPartialHit, 
    transitionTimer, setTransitionTimer, sessionKillsNoHit, setSessionKillsNoHit, 
    sessionTimeNoHit, setSessionTimeNoHit, sessionLivesBought, setSessionLivesBought, 
    setDoubleBossSpawned, tutorialStep, setTutorialStep, gameStats, saveStats 
} from './config.js';

import { activateTutorial } from './tutorial.js';
import { unlockAchievement, updateUpgradesHUD, updateTrophiesHUD } from './ui.js';
...
export function handleDamage(updateLivesUIFunc, gameOverFunc) { 
    ...
    setLives(lives - 1); setSessionKillsNoHit(0); setSessionTimeNoHit(0); updateLivesUIFunc(); if (lives <= 0) gameOverFunc(); 
}

export function handleCoinEarned(amount) { 
...
export function damageBoss(bIndex, dmg, bgMusic) {
...
export function damageEnemy(eIndex, dmg) {
