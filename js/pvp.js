...
(() => {
  ...
  function updateQueueStatus(){
    ...
    showStatus('🔎 Buscando '+searchLabel+'… '+mm+':'+ss+' · 👥 '+Math.min(queueWaitingCount,needed)+'/'+needed+' conectados · ⏱️ Máx. '+([20,25,30,40,50,60,75][pvpRankFromCups(qaBotCups()).level]||20)+' s',true);
  }
