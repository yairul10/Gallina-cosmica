...
if "getGamesSignInClient" not in text:
    text, count = re.subn(
        ...
        '                if (authenticated) {\n'
        '                    android.util.Log.i("PlayGames", "Authentication: success");\n'
        '                    return;\n'
        '                }\n'
        '                android.util.Log.i("PlayGames", "Authentication unavailable; starting sign-in");\n'
        '                gamesSignInClient.signIn()\n'
        '                    .addOnCompleteListener(signInTask -> {\n'
        '                        boolean signedIn = signInTask.isSuccessful()\n'
        '                            && signInTask.getResult().isAuthenticated();\n'
        '                        android.util.Log.i("PlayGames", "Sign-in: "\n'
        '                            + (signedIn ? "success" : "failed"));\n'
        '                        if (!signInTask.isSuccessful() && signInTask.getException() != null) {\n'
        '                            android.util.Log.e("PlayGames", "Sign-in error", signInTask.getException());\n'
        '                        }\n'
        '                    });\n'
        '            });\n'
        '    }',
