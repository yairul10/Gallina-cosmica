...
if not plugin.exists():
    plugin.write_text(
        ...
        '            return "Código Play Games " + apiError.getStatusCode() + ": " + apiError.getMessage();\n'
        '        }\n'
        '        return error == null ? "Sin detalle de Google Play Games." : error.getClass().getSimpleName() + ": " + error.getMessage();\n'
        '    }\n\n'
        ...
        '                result.put("detail", authenticated ? "Sesión confirmada." : (task.isSuccessful() ? "Google no confirmó una sesión activa." : errorDetail(task.getException())));\n'
        '                call.resolve(result);\n'
        '            });\n'
        '    }\n\n'
        '    @PluginMethod\n'
        ...
        '                result.put("detail", playerAvailable ? "Perfil de jugador disponible." : errorDetail(task.getException()));\n'
        '                call.resolve(result);\n'
        '            });\n'
        '    }\n\n'
        '    @PluginMethod\n'
        ...
        '                    result.put("authenticated", authenticated);\n'
        '                    result.put("detail", authenticated ? "Google confirmó la sesión." : "Google no confirmó una sesión tras el intento de acceso.");\n'
        '                    call.resolve(result);\n'
        '                })\n'
        '        );\n'
        '    }\n'
